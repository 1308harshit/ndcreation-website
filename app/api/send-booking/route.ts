...
export async function POST(request: NextRequest) {
  try {
    ...
    const data = await resend.emails.send({
      ...
      subject: `[NDcreations Website] New Service Booking: ${serviceType} - From ${name}`,
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="header">
              <h1 style="margin: 0; font-size: 24px;">💼 New Service Booking from NDcreations Website</h1>
            </div>
            ...
            <div class="content">
              ...
              <div class="footer">
                ...
                <div><strong>🌐 Source:</strong> NDcreations Service Booking Form</div>
